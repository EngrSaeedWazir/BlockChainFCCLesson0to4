...
//error NotOwner();// for revert use which is ga efficient
 ...
 contract FundMe{
    ...
    function Fund() public payable {
       ...
       require(msg.value.getConversionRate() >= minimumUsd, "You need to spend more ETH!"); //value paramter pass to function in Library
    ...
    function Withdraw() public  onlyOwner {
      ...
      //call 
      (bool callSuccess, /* byte memory storedata */)=payable(msg.sender).call{value: address(this).balance}("");
